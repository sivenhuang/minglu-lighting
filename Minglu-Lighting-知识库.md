...
- **产品数**：**136 个产品**，12 个分类
- **产品来源**：早期从行业参考站点采集，站内素材现已全部替换为自有图（assets/images/）
- **图片**：已全部迁移至本地 `assets/images/`，无第三方外链
...
### 图片抓取
- ✅ 站内产品图一律使用**自有授权素材**，存放于 `assets/images/`，禁止外链第三方图床
- ✅ 抓取外部参考图时务必确认版权与授权；对方站点的 LOGO、认证标志等品牌素材需排除，避免侵权
- 🚫 不得抓取或复用竞争对手网站的图片与文案
